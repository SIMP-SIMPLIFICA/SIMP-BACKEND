...
export class PdfService {
    ...
    async generate(data: PdfData): Promise<Buffer> {
        ...
        // Usa apenas a logo do usuário — sem fallback para logo padrão do sistema
        // Se o usuário não configurou logo (logo_base64 = null/undefined), o PDF ficará sem logo
        let safeLogo = data.logo_base64 || undefined;
