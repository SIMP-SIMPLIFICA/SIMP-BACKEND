...
var helpers_1 = require("node-signpdf/dist/helpers"); // Ajuste o import conforme versão
var node_signpdf_1 = __importDefault(require("node-signpdf"));
var SignatureService = /** @class */ (function () {
     ...
     */
    SignatureService.prototype.signPdf = function (pdfBuffer, pfxBuffer, password) {
        return __awaiter(this, void 0, void 0, function () {
            var pdfWithPlaceholder, p12Asn1, p12, signedPdf;
            return __generator(this, function (_a) {
                pdfWithPlaceholder = (0, helpers_1.plainAddPlaceholder)({
                    pdfBuffer: pdfBuffer,
                ...
                p12Asn1 = node_forge_1.default.asn1.fromDer(pfxBuffer.toString('binary'));
                p12 = node_forge_1.default.pkcs12.pkcs12FromAsn1(p12Asn1, false, password);
                signedPdf = node_signpdf_1.default.sign(pdfWithPlaceholder, pfxBuffer, { passphrase: password });
